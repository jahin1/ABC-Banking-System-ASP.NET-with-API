...
{
    public class TOfficerAuthenticationAttribute : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                TOfficerRepository urepo = new TOfficerRepository();

                if (username == urepo.Get(username).TO_name && password == urepo.Get(username).TO_password)
                {
